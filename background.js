    ...
    return new Promise((resolve) => {
        setTimeout(() => {
            resolve({
                ...
                LLM_output_short: "La sostenibilità è essenziale per il futuro del pianeta. Ogni azione che intraprendiamo oggi può influire sull'ambiente domani. Adottare pratiche ecologiche, ridurre gli sprechi e promuovere il riciclo sono passi cruciali verso un mondo più verde e pulito.",
